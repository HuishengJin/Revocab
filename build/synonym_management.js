...
(() => {
/*!*******************************************************!*\
  !*** ./src/active_vocab_manage/synonym_management.js ***!
  \*******************************************************/
__webpack_require__.r(__webpack_exports__);
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    document.getElementById('saveSynonymsBtn').addEventListener('click', async () => {
        ...
        await (0,_utils_storageUtils_js__WEBPACK_IMPORTED_MODULE_0__.updateVocabSynonyms)(vocabWord, updatedSynonyms);
